...
public:
	...
	using BuildMaterial = std::function<MaterialInstance(VkDevice, MaterialPassType, const MetallicRoughnessMaterial::MaterialResources&, DescriptorAllocatorGrowable&)>;
